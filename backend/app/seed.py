...
to select from, and "Add Expense" is unusable on first run. These are
sensible V1 defaults; all of them are editable/deletable later through
Settings (deletion blocked only if referenced, per the approved business
rule).
"""
